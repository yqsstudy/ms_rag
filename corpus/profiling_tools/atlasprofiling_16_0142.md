---
title: "msprof导出db格式数据说明"
source: "https://www.hiascend.com/document/detail/zh/mindstudio/830/T&ITools/Profiling/atlasprofiling_16_0142.html"
date_collected: "2026-05-04"
category: "profiling_tools"
original_path: "zh/mindstudio/830/T&ITools/Profiling/atlasprofiling_16_0142.html"
---
...
与startNs联合索引，索引名称TaskIndex，用于唯一标识全局算子任务
...
算子的动静态信息，dynamic表示动态算子，static表示静态算子，N/A表示该场景或该算子不识别，STRING_IDS(opState)

hf32Eligible

INTEGER

标识是否使用HF32精度标记，YES表示使用，NO表示未使用，N/A表示该场景或该算子不识别，STRING_IDS(hf32Eligible)
|  |  |  |
| --- | --- | --- |
|  |  |  |
|  |  |  |
...
- Ascend PyTorch Profiler的aic_metrics
- MindSpore Profiler的aic_metrics
...
core类型(AIC或AIV)，STRING_IDS(coreType)
|  |  |  |
| --- | --- | --- |
|  |  |  |
|  |  |  |
...
PMU metric指标名，STRING_IDS(metric)
...
该API所在线程的全局TID。高32位：PID，低32位：TID
