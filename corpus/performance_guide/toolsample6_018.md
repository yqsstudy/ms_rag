---
title: 集群性能分析
source: https://www.hiascend.com/document/detail/zh/mindstudio/830/practicalcases/GeneralPerformanceIssue/toolsample6_018.html?framework=pytorch
date_collected: 2026-04-29
---

# 集群性能分析

> 来源: [https://www.hiascend.com/document/detail/zh/mindstudio/830/practicalcases/GeneralPerformanceIssue/toolsample6_018.html?framework=pytorch](https://www.hiascend.com/document/detail/zh/mindstudio/830/practicalcases/GeneralPerformanceIssue/toolsample6_018.html?framework=pytorch)
...
**图1** 概览界面   
![](images/toolsample6_018_zh-cn_image_0000002504087158.png)
...
**图2** 典型Case1   
![](images/toolsample6_018_zh-cn_image_0000002504087162.png)
...
**图3** 典型Case2   
![](images/toolsample6_018_zh-cn_image_0000002535887153.png)

卡数较多时，呈现的全量数据过多，不利于查看分析，如图4所示。需要通过合理的方式，**精简拆分** 数据，让分析方向更加明确。

**图4** ”计算/通信概览”页面全量数据展示   
![](images/toolsample6_018_zh-cn_image_0000002504087154.png)

精简方式1：左键点击通信域连线（例如下图中①），单独查看某个通信域，得到按通信域拆解后的概览图。点击框也有类似效果（同一根连线代表同一个通信域、同一个框内代表并行分组）。 

**图5** 按通信域拆解后的计算/通信概览   
![](images/toolsample6_018_zh-cn_image_0000002535807119.png)
...
**图6** DP+PP维度（TP被折叠）   
![](images/toolsample6_018_zh-cn_image_0000002535887151.png)
...
**图7** DP+PP+TP维度（全展开维度）   
![](images/toolsample6_018_zh-cn_image_0000002503927330.png)

    3. 定位到慢卡后，可右键点击感兴趣的通信域连线（如此处的绿色连线，代表TP通信域），查看通信耗时分析，前往通信（Communication）界面进一步分析慢卡的通信过程，如图8和图9所示。 

**图8** 右键连线，查看通信耗时分析   
![](images/toolsample6_018_zh-cn_image_0000002535807123.png)

**图9** 通信（Communication）界面-通信耗时分析   
![](images/toolsample6_018_zh-cn_image_0000002504087160.png)
